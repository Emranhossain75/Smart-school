...
namespace SmartSchool.Controllers
{
    public class TeachersController : Controller
    {
        ...
        // GET: Teachers/Register // for teachers
        [HttpGet]
        ...
        public void SendVerificationLinkEmail(string email, string activationCode, string emailFor = "VerifyAccount")
        {
            try
            {
                ...
                var fromEmail = new MailAddress("raihan35-1542@diu.edu.bd", "SmartSchool");
                var toEmail = new MailAddress(email);
                var fromEmailPassword = "105500104330"; // Replace with actual password
        ...
        // GET: Teachers/Login // for teachers
        [HttpGet]
        ...
        // GET: Teachers/ForgotPassword // for teacher
        [HttpGet]
