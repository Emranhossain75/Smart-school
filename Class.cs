...
namespace SmartSchool.Models
{
    public class Class
    {
        ...
        public bool addClass()
        {
            ...
            string query2 = @"CREATE TABLE Class"+ ClassNo + " (Id int primary key, StudentID nvarchar (10) not null foreign key references Students(Id), Roll int, Section nvarchar (1), SubjectName nvarchar (100), Mid int, Final int, Year nvarchar (4))";
